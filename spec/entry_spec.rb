...
RSpec.describe RegistersClient::Entry do
  Entry_rsf_line = "append-entry\tuser\tGB\t2016-04-05T13:23:05Z\tsha-256:6b18693874513ba13da54d61aafa7cad0c8f5573f3431d6f1c04b07ddb27d6bb"

  describe 'entry_number' do
    it 'should return the entry number' do
      entry = RegistersClient::Entry.new(Entry_rsf_line, 2)
  ...
  describe 'key' do
    it 'should return the key' do
      entry = RegistersClient::Entry.new(Entry_rsf_line, 1)
